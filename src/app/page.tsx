...
export default function RegisterForm() {
  ...
  const updateAgree = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  console.log(`bottle : ${buyBottle} shoes : ${buyShoes} cap : ${buyCap} `);
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        <input className="me-2" type="checkbox" onChange={updateAgree} />I agree
